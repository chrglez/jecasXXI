---
title: "Panel de datos de Turismo de Lanzarote"
subtitle: "Una aplicación de datos abiertos en la administración pública"
...
Actualmente, el turismo genera 16099 millones de euros en Canariaá, el 35% del conjunto de su economía, y 343899 empleos, un 40.4% del total, según el último estudio de IMPACTUR [`r fa("external-link-alt", fill = "#43418a")`](https://www.exceltur.org/impactur-2/#)
...
Esta aplicación emplea el la API ISTACbase a través de la librería istacbaser. Se usa la información obtenida de la Encuesta de Gasto Turístico de Canarias.
...
---
![Mapa de oferta aljativa por municipios](images/mapa.png)
...
- Desarrollo del 'Panel de Indicadores de Turismo de Lanzarorte'
...
# Panel de datos de Turismo de Lanzarote: Una aplicación de datos abiertos en la administración pública
